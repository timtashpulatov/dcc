...
// Advanced Operation Sub-functions
#define ADV_SUBF_128_SPEED_STEP_CONTROL		0b00011111
#define ADV_SUBF_RESTRICTED_SPEED_STEP		0b00011110
#define ADV_SUBF_ANALOG_FUNC_GROUP			0b00011101
